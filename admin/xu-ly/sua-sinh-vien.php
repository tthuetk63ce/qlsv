<?php 
	...
	{
		$suasv = "UPDATE `tai_khoan` SET `ten_tai_khoan` = '$masv', `mat_khau` = '$matkhau', `ten_sinh_vien` = '$tensv', `lop_sinh_vien` = '$svlop', `khoa_sinh_vien` = '$ten_khoa', `sdt` = '$sdt', `ngay_sinh` = '$ngaysinh', `nhan_xet` = '$nhanxet' WHERE `tai_khoan`.`id_tai_khoan` = $idsv";
