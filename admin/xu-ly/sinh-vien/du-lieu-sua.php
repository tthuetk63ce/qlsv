...
<div class="row">
	...
	<input type="text" id="idsv" value="<?php echo $id?>" style="display: none">
		...
		<div class="form-group">
		    ...
		    <input class="form-control" id="masv" type="text" placeholder="Mã sinh viên..." autofocus="autofocus" value="<?php echo $row["ten_tai_khoan"]?>">
		    </div>
	    </div>
	</div>
	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
		...
		<div class="form-group">
		    ...
		    <input class="form-control" id="tensv" type="text" placeholder="Họ tên sinh viên..." value="<?php echo $row["ten_sinh_vien"]?>">
		    </div>
	    </div>
	</div>
